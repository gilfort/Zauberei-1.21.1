...
public class ZaubereiRecipeProvider extends RecipeProvider implements IConditionBuilder {
    public ZaubereiRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries);
    }

    @Override
    protected void buildRecipes(RecipeOutput recipeOutput) {
//        List<ItemLike> BISMUTH_SMELTABLES = List.of(ZaubereiItems.RAW_BISMUTH,
//                ZaubereiBlocks.BISMUTH_ORE, ZaubereiBlocks.BISMUTH_DEEPSLATE_ORE);
//
//        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ZaubereiBlocks.BISMUTH_BLOCK.get())
//                .pattern("BBB")
//                .pattern("BBB")
//                .pattern("BBB")
    ...
    protected static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput recipeOutput, RecipeSerializer<T> pCookingSerializer, AbstractCookingRecipe.Factory<T> factory,
        ...
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer, factory).group(pGroup).unlockedBy(getHasName(itemlike), has(itemlike))
                    .save(recipeOutput, Zauberei.MODID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
    }
}